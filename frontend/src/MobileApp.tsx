...
type Tab = 'home' | 'tasks' | 'bulletins' | 'teleprompter' | 'script' | 'settings';
  ...
  return (
    <div className="mobile-app">
      ...
      <div className="mobile-content">
          ...
          <>
            ...
            <div className="section-header">Quick Actions</div>
             <div className="action-grid">
               ...
               <div className="action-btn" onClick={() => setTab('teleprompter')}>
                 <span className="icon">🎬</span>
                 Teleprompter
               </div>
               <div className="action-btn" onClick={() => setTab('script')}>
                 <span className="icon">📝</span>
                 Script
               </div>
        ...
        {tab === 'teleprompter' && (
          <div className="mobile-screen">
            ...
            <div className="mobile-list">
              <div className="mobile-list-item" onClick={() => window.location.href = '/teleprompter'}>
                <div className="item-icon purple">🎬</div>
                <div className="item-text">
                  <div className="item-title">Open Teleprompter</div>
                  <div className="item-sub">Fullscreen studio screen</div>
                </div>
                <div className="item-arrow">›</div>
              </div>
              <div className="mobile-list-item">
                <div className="item-icon blue">ℹ️</div>
                <div className="item-text">
                  <div className="item-title">How it works</div>
                  <div className="item-sub">Access the teleprompter from any device on your LAN</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bottom-nav">
        ...
        <button className={`nav-item ${tab === 'teleprompter' ? 'active' : ''}`} onClick={() => setTab('teleprompter')}>
          <span className="nav-icon">🎬</span>
          TV
        </button>
        <button className={`nav-item ${tab === 'script' ? 'active' : ''}`} onClick={() => setTab('script')}>
          <span className="nav-icon">📝</span>
          Script
        </button>
